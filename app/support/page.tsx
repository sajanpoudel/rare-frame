  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 sm:py-12 bg-white rounded-xl shadow-sm my-8">
      ...
      <div className="prose prose-blue max-w-none">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-medium text-gray-800 mb-3">What is RARE EVO 2025?</h3>
              <p className="text-gray-600">
                RARE EVO 2025 is the premier web3 and NFT event taking place August 6-10, 2025 at Caesar's Palace in Las Vegas, NV. Our event brings together creators, collectors, developers, and enthusiasts from around the world to explore the future of digital ownership and blockchain technology.
              </p>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-medium text-gray-800 mb-3">How do NFT tickets work?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-medium text-gray-800 mb-3">What wallet should I use?</h3>
              <p className="text-gray-600">
                We recommend using MetaMask, Coinbase Wallet, or Rainbow for the best experience. Make sure your wallet is compatible with the Base network. If you need help setting up your wallet for Base, please consult our <a href="#" className="text-blue-600 hover:text-blue-800">wallet setup guide</a>.
              </p>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-medium text-gray-800 mb-3">Can I try the app without purchasing?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-medium text-gray-800 mb-3">Can I transfer or sell my ticket?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-medium text-gray-800 mb-3">What if I can't attend after purchasing?</h3>
              <p className="text-gray-600">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Common Issues & Troubleshooting</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
              <div className="flex items-center mb-4">
                <FaTicketAlt className="text-blue-600 text-xl mr-3" />
                <h3 className="text-xl font-medium text-gray-800">Ticket Not Showing</h3>
              </div>
              <p className="text-gray-600">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
              <div className="flex items-center mb-4">
                <FaWallet className="text-blue-600 text-xl mr-3" />
                <h3 className="text-xl font-medium text-gray-800">Wallet Connection</h3>
              </div>
              <p className="text-gray-600">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
              <div className="flex items-center mb-4">
                <FaQuestion className="text-blue-600 text-xl mr-3" />
                <h3 className="text-xl font-medium text-gray-800">Registration Issues</h3>
              </div>
              <p className="text-gray-600">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
              <div className="flex items-center mb-4">
                <FaTicketAlt className="text-blue-600 text-xl mr-3" />
                <h3 className="text-xl font-medium text-gray-800">QR Code Issues</h3>
              </div>
              <p className="text-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:support@rareevo.io" className="text-blue-600 hover:text-blue-800">support@rareevo.io</a>
                  <p className="text-gray-600 mt-3 mb-1">For technical issues:</p>
                  <a href="mailto:tech@rareevo.io" className="text-blue-600 hover:text-blue-800">tech@rareevo.io</a>
                </div>
              </div>
              
              <div className="flex items-start">
                <div className="bg-white p-3 rounded-full shadow-sm mr-4">
                  <FaDiscord className="text-blue-600 text-xl" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Community Support</h3>
                  <p className="text-gray-600 mb-2">Join our Discord server for real-time support from our team and community members.</p>
                  <a href="https://discord.gg/rareevo" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200">Join Discord</a>
                </div>
              </div>
            </div>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Event Information</h2>
          
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-medium text-gray-800 mb-3">RARE EVO 2025</h3>
            <ul className="space-y-2 text-gray-600">
              <li><strong>Dates:</strong> August 6-10, 2025</li>
              <li><strong>Location:</strong> Caesar's Palace, Las Vegas, NV</li>
              <li><strong>Check-in Hours:</strong> 8:00 AM - 6:00 PM daily</li>
              <li><strong>Age Requirement:</strong> 21+ (valid ID required)</li>
            </ul>
            
            <div className="mt-6">
              <h4 className="text-lg font-medium text-gray-800 mb-2">Follow Us</h4>
              <div className="flex space-x-4">
                <a href="https://twitter.com/rareevoofficial" className="text-gray-600 hover:text-blue-600 transition duration-200">
                  <FaTwitter className="text-xl" />
                </a>
                <a href="https://discord.gg/rareevo" className="text-gray-600 hover:text-indigo-600 transition duration-200">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
              ...
              <div className="flex space-x-6">
                ...
                <Link href="/terms" className="text-blue-600 hover:text-blue-800">Terms &amp; Conditions</Link>
              </div>
            </div>
          </div>
        </section>
