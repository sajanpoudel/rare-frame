  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 sm:py-12 bg-white dark:bg-gray-800 rounded-xl shadow-sm my-8">
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">2. NFT Tickets and Event Access</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h3 className="text-xl font-medium text-gray-700 dark:text-gray-200 mb-3">2.1 Ticket Ownership Rights</h3>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h3 className="text-xl font-medium text-gray-700 dark:text-gray-200 mb-3">2.2 License</h3>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h3 className="text-xl font-medium text-gray-700 dark:text-gray-200 mb-3">2.3 Ticket Transfer and Resale Policies</h3>
          <p className="text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">3. RarePerks Loyalty Program</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">4. User Representations and Age Requirements</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">By using the Services, you represent and warrant that:</p>
          <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">5. Purchases and Payment</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            NFT tickets are priced as follows:
          </p>
          <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700 dark:text-gray-300">
            <li><strong className="text-gray-800 dark:text-gray-200">General Admission (GA):</strong> 0.0001 ETH</li>
            <li><strong className="text-gray-800 dark:text-gray-200">VIP:</strong> 0.3 ETH</li>
            <li><strong className="text-gray-800 dark:text-gray-200">WHALE PASS:</strong> 1.0 ETH</li>
          </ul>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">6. Demo Mode and Free Trials</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">7. Event Policies and Attendee Conduct</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">8. Intellectual Property Rights</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">9. Cancellation and Force Majeure</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">10. Limitation of Liability</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">11. Dispute Resolution</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">12. Contact Us</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            If you have any questions about these Terms and Conditions, please contact us at:
          </p>
          <p className="mt-2 text-gray-700 dark:text-gray-300">
            <strong className="text-gray-800 dark:text-gray-200">Email:</strong> <a href="mailto:legal@rareevo.io" className="text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300">legal@rareevo.io</a><br />
